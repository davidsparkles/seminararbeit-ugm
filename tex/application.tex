With its simple generic definition undirected graphical models have a lot of application areas. Starting from theoretically modeling physical interactions, like magnetism as mentioned in section \ref{sec:motivation}, to more recent fields of research in the domains of information retrieval, natural language, speech (as for example in \cite{}) and image processing but also in the field of machine learning (as for example in \cite{}). In order to give a few examples of application this section introduces three examples, where Markov networks are utilized: section \ref{sec:term} describes how undirected graphical models are used to express term dependencies in the field of information retrieval and last but not least section \ref{sec:image} describe a method of gaining a higher resoluteted image by using Markov networks and training data.
...
TODO: \href{http://cs.brown.edu/courses/csci1950-g/results/final/pachecoj/}{Refers to the paper}
...
%\label{sec:speech}
% probably not necessary
%TODO Maybe dont do this, cause it is a markov model (process) and not a markov network \cite{gales2008application}
