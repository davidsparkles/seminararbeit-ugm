...
% TODO: change basic to the misconception example (A,B)(B,C)(C,D)(D,A)
...
Still the computation costs can be very high for exact inference, if the network is very large. In order to achieve viable computation times, approximation methods are used. Amongst them are for example the direct sampling or the Markov Chain Monte Carlo sampling. %TODO: cite sources (Short description)
